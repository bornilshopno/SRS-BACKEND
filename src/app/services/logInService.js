...
export const saveLogInInfo = async (loginDetails) => {
    try {
        ...
        // console.log("loginDetails Save", loginDetails)
        ...
        console.error("email :", email, "login time", loginTime, "Error saving login info:", error);
        return { success: false, error: error.message };
    }
};

export const updateLogInService = async (loginDetails) => {
    try {
        const {
            userId,
            email,
